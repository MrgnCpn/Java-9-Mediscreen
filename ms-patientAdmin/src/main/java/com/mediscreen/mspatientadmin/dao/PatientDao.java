...
public class PatientDao extends DaoManager implements PatientDaoInterface {
    /**
     * Constructor
     */
    public PatientDao(DatabaseConfigurationInterface databaseConfiguration) {
        super(databaseConfiguration, "PatientDao");
    }
